...
class LiveTradingPage(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.positions_table.setHorizontalHeaderLabels(["Symbol", "Side", "Quantity", "Entry Price", "Current Price", "P&L"])
        ...
        self.orders_table.setHorizontalHeaderLabels(["Time", "Symbol", "Type", "Quantity", "Price"])
