...
from PyQt6.QtWidgets import (QComboBox, QDateEdit, QGroupBox, QHBoxLayout,
...
class DataManagerPage(QWidget):
    ...
    def _on_download_error(self, error: str):
        ...
        QMessageBox.critical(
            self, "Download Error", f"Failed to download data:\n{error}"
        )
    ...
    def _validate_data(self):
        ...
        if issues:
            ...
            QMessageBox.information(
                self, "Validation Passed", "✓ Data validation passed all checks!"
            )
