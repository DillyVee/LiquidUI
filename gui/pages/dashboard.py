...
class DashboardPage(QWidget):
    ...
    def _setup_ui(self):
        ...
        # Welcome message
        welcome = QLabel(f"Welcome back! Last updated: {datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
        ...
        recent_label.setStyleSheet("font-size: 18px; font-weight: bold; color: #E0E0E0; margin-top: 10px;")
        layout.addWidget(recent_label)
        
        # Trades table
        table = QTableWidget(5, 6)
        table.setHorizontalHeaderLabels(["Time", "Symbol", "Side", "Quantity", "Price", "P&L"])
